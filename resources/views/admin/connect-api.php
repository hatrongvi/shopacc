            ...
            <div class="row">
                ...
                <section class="col-lg-6 connectedSortable">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                <p>Hướng dẫn sử dụng: <a target="_blank" href="https://www.cmsnt.co/2022/12/shopclone6-huong-dan-su-dung-tinh-nang.html">https://www.cmsnt.co/2022/12/shopclone6-huong-dan-su-dung-tinh-nang.html</a></p>
