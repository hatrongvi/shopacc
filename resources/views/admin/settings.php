                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <i>VD: <?=$CMSNT->site('max_register_ip');?> => mỗi IP chỉ được tạo tối đa <?=$CMSNT->site('max_register_ip');?> tài khoản</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <p>Nếu bạn đặt mã PIN, các liên kết CRON sẽ phải chèn thêm đoạn <b>in đậm</b> <?=base_url('cron/');?>...php<b style="font-size: 15px;">?pin=<?=$CMSNT->site('pin_cron');?></b> vào liên kết để tránh spam, để trống nếu không dùng chức năng này.</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <i>Nếu OFF, hệ thống sẽ chặn các website khác kết nối API để mua hàng.</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung thông báo khi import tài
                                                nguyên</label>
                                            <textarea name="noti_import_telegram" placeholder="Để trống để ẩn thông báo này"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung thông báo khi đăng ký tài
                                                khoản</label>
                                            <textarea name="register_notification" placeholder="Để trống để ẩn thông báo này"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="naptien_notification" placeholder="Để trống để ẩn thông báo này"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung thông báo khi khách tạo hoá đơn nạp tiền</label>
                                            <textarea name="taohoadonnaptien_notification" placeholder="Để trống để ẩn thông báo này"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nội dung thông báo khi khách yêu cầu tạo website con</label>
                                ...
                                <div class="tab-pane fade" id="tab9" role="tabpanel" aria-labelledby="tab9">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Email Nowpayment (<a type="button"
                                                    data-toggle="modal" data-target="#modal-hd-crypto" href="#">Xem
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="email_nowpayments"
                                                value="<?=$CMSNT->site('email_nowpayments');?>" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Password Nowpayment (<a type="button"
                                                    data-toggle="modal" data-target="#modal-hd-crypto" href="#">Xem
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="password_nowpayments"
                                                value="<?=$CMSNT->site('password_nowpayments');?>" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">API Key (<a type="button"
                                                    data-toggle="modal" data-target="#modal-hd-crypto" href="#">Xem
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="apikey_nowpayments"
                                                value="<?=$CMSNT->site('apikey_nowpayments');?>" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ipn_nowpayments"
                                                value="<?=$CMSNT->site('ipn_nowpayments');?>" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Số tiền nạp tối thiểu</label>
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="billChargeToCustomer">
                                                <option <?=$CMSNT->site('billChargeToCustomer') == '0' ? 'selected' : '';?>
                                                    value="0">Your customers pay a fee
                                                </option>
                                                <option <?=$CMSNT->site('billChargeToCustomer') == '' ? 'selected' : '';?>
                                                    value="">You pay fees
                                                </option>
                                            </select>
                                            <i>Select OFF, the system will hide recharge via Toyyibpay</i>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li>Bước 3: Nhìn vào <b>Payout Wallet</b>, bạn nhấn vào <b>Add another wallet</b>, sau đó bạn chọn
                        tên ví <b>Currency</b> và nhập địa chỉ ví của bạn vào.</li>
                    <li>Bước 4: Nhấn vào <b>API Keys</b>, bạn nhấn vào <b>Add new key</b> sau đó copy đoạn key được tạo
                        ra, truy cập trang quản trị của bạn, dán đoạn key vừa copy vào ô API Key.</li>
                    <li>Bước 5: Nhìn vào <b>Instant Payment Notifications</b>, bạn thực hiện tạo <b>IPN secret key</b>
                        bằng cách nhấn vào <b>Generate</b>, sau đó bạn copy đoạn mã vừa tạo dán vào ô IPN trong trang
                        quản trị (vui lòng bảo mật thông tin này tránh hacker fake giao dịch). </li>
                    <li>Bước 6: Đên đây quý khách có thể sử dụng hệ thống, sau khi user nạp tiền vào hệ thống thông qua
                        Crypto, số dư coin của quý khách sẽ được chuyển thẳng vào ví mà quý khách thêm ở bước 3.</li>
                </ul>
