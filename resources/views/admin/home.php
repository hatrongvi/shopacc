    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="alert alert-dark">
                ...
                <ul>
                    <li>Chi tiết cập nhật vui lòng xem tại <a target="_blank" href="https://zalo.me/g/idapcx933">đây</a> (chỉ áp dụng cho khách hàng mua chính hãng tại CMSNT.CO)</li>
                    <!-- <li>29/08/2022: Thêm mã QR cho nạp tiền server 2.</li>
