                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                                        ...
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            ...
                                            <li onclick="changeLanguage(<?=$lang['id'];?>)"
                                                class="dropdown-item-1 list-group-item px-2"><a class="p-0"
                                                    href="#" style="color: #8f9fbc;"><img src="<?=BASE_URL($lang['icon']);?>" alt="img-flaf"
                        ...
                        <li class="sidebar-layout">
                            <a href="#" class="svg-icon dropdown-toggle" id="dropdownMenuButton2" data-toggle="dropdown"
                                ...
                                <span class="ml-2"><b><?=getRowRealtime('currencies', getCurrency(), 'code');?></b></span>
                            </a>
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="card shadow-none m-0 border-0">
                                    <div class=" p-0 ">
                                        <ul class="dropdown-menu-1 list-group list-group-flush">
                                            ...
                                            <li onclick="changeCurrency(<?=$currency['id'];?>)"
                                                class="dropdown-item-1 list-group-item px-2"><a class="p-0"
                                                    href="#" style="color: #8f9fbc;"><?=$currency['code'];?> </a>
                                            </li>
                                            <?php }?>
                                        </ul>
                                    </div>
                        ...
                        <li class="px-3 pt-3 pb-2 ">
                            <span class="text-uppercase small font-weight-bold"><?=__('Số dư');?> <span
                                    style="color: yellow;"><?=format_currency(isset($getUser['money']) ? $getUser['money'] : 0);?></span> - <?=__('Giảm');?>: <span style="color: red;"><?=isset($getUser['chietkhau']) ? $getUser['chietkhau'] : 0;?>%</span>
                            </span>
                        </li>
